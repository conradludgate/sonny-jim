...
### Ryzen 9 7950x - Linux 6.8.12 glibc

```
Timer precision: 10 ns
parse                     fastest       │ slowest       │ median        │ mean          │ samples │ iters
├─ kube                                 │               │               │               │         │
│  ├─ serde               5.013 ms      │ 7.226 ms      │ 5.267 ms      │ 5.304 ms      │ 400     │ 2000
│  │                      alloc:        │               │               │               │         │
│  │                        101400      │ 101400        │ 101400        │ 101400        │         │
│  │                        14.09 MB    │ 14.09 MB      │ 14.09 MB      │ 14.09 MB      │         │
│  │                      dealloc:      │               │               │               │         │
│  │                        101400      │ 101400        │ 101400        │ 101400        │         │
│  │                        14.29 MB    │ 14.29 MB      │ 14.29 MB      │ 14.29 MB      │         │
│  │                      grow:         │               │               │               │         │
│  │                        1165        │ 1165          │ 1165          │ 1165          │         │
│  │                        201.8 KB    │ 201.8 KB      │ 201.8 KB      │ 201.8 KB      │         │
│  ├─ serde_raw           1.078 ms      │ 1.315 ms      │ 1.137 ms      │ 1.134 ms      │ 400     │ 2000
│  │                      alloc:        │               │               │               │         │
│  │                        1           │ 1             │ 1             │ 1             │         │
│  │                        8 B         │ 8 B           │ 8 B           │ 8 B           │         │
│  │                      dealloc:      │               │               │               │         │
│  │                        1           │ 1             │ 1             │ 1             │         │
│  │                        8 B         │ 8 B           │ 8 B           │ 8 B           │         │
│  ├─ simd_json_borrowed  4.067 ms      │ 5.314 ms      │ 4.138 ms      │ 4.16 ms       │ 400     │ 2000
│  │                      alloc:        │               │               │               │         │
│  │                        45891       │ 45891         │ 45891         │ 45891         │         │
│  │                        19.07 MB    │ 19.07 MB      │ 19.07 MB      │ 19.07 MB      │         │
│  │                      dealloc:      │               │               │               │         │
...
│  │                        2           │ 2             │ 2             │ 2             │         │
│  │                        5.889 MB    │ 5.889 MB      │ 5.889 MB      │ 5.889 MB      │         │
│  ╰─ sonny_jim           2.616 ms      │ 2.68 ms       │ 2.661 ms      │ 2.656 ms      │ 400     │ 2000
│                         alloc:        │               │               │               │         │
│                           16          │ 16            │ 16            │ 16            │         │
│                           74.22 KB    │ 74.22 KB      │ 74.22 KB      │ 74.22 KB      │         │
│                         dealloc:      │               │               │               │         │
│                           16          │ 16            │ 16            │ 16            │         │
│                           2.47 MB     │ 2.47 MB       │ 2.47 MB       │ 2.47 MB       │         │
│                         grow:         │               │               │               │         │
...
│                           2.395 MB    │ 2.395 MB      │ 2.395 MB      │ 2.395 MB      │         │
╰─ small                                │               │               │               │         │
   ├─ serde               371.9 ns      │ 397.4 ns      │ 379.8 ns      │ 380.7 ns      │ 4000    │ 2000000
   │                      alloc:        │               │               │               │         │
   │                        11          │ 11            │ 11            │ 11            │         │
   │                        1.442 KB    │ 1.442 KB      │ 1.442 KB      │ 1.442 KB      │         │
   │                      dealloc:      │               │               │               │         │
   ...
   │                        1           │ 1             │ 1             │ 1             │         │
   │                        8 B         │ 8 B           │ 8 B           │ 8 B           │         │
   ├─ serde_raw           116.3 ns      │ 137.2 ns      │ 119.2 ns      │ 119.6 ns      │ 4000    │ 2000000
   │                      alloc:        │               │               │               │         │
   │                        1           │ 1             │ 1             │ 1             │         │
   │                        8 B         │ 8 B           │ 8 B           │ 8 B           │         │
   │                      dealloc:      │               │               │               │         │
   │                        1           │ 1             │ 1             │ 1             │         │
   │                        8 B         │ 8 B           │ 8 B           │ 8 B           │         │
   ├─ simd_json_borrowed  477.9 ns      │ 822.2 ns      │ 494.1 ns      │ 507.1 ns      │ 4000    │ 2000000
   │                      alloc:        │               │               │               │         │
   │                        12          │ 12            │ 12            │ 12            │         │
   │                        1.646 KB    │ 1.646 KB      │ 1.646 KB      │ 1.646 KB      │         │
   │                      dealloc:      │               │               │               │         │
   ...
   │                        4           │ 4             │ 4             │ 4             │         │
   │                        1.084 KB    │ 1.084 KB      │ 1.084 KB      │ 1.084 KB      │         │
   ╰─ sonny_jim           443.5 ns      │ 476.4 ns      │ 453 ns        │ 454.1 ns      │ 4000    │ 2000000
                          alloc:        │               │               │               │         │
                            8           │ 8             │ 8             │ 8             │         │
                            500 B       │ 500 B         │ 500 B         │ 500 B         │         │
                          dealloc:      │               │               │               │         │
                            8           │ 8             │ 8             │ 8             │         │
                            732 B       │ 732 B         │ 732 B         │ 732 B         │         │
                          grow:         │               │               │               │         │
                            3           │ 3             │ 3             │ 3             │         │
                            232 B       │ 232 B         │ 232 B         │ 232 B         │         │
```
